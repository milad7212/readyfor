...
function Hero() {
  return (
    <div style={{ direction: "ltr" }} className="min-h-screen bg-primary p-4">
      <div className="relative overflow-hidden">
            ...
            <div className="mx-auto px-4">
              <div className="sm:text-center lg:text-right">
                ...
                <p className="mt-3 font-bold text-SecondaryText sm:mx-auto sm:mt-5 sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                  تمام تالار های شهر اینجاست. میتونی ببینی و رزور کنی
                </p>
        ...
        <Lottie animationData={LandingBanner} loop={true} />;
        </div>
        </div>
      </div>
    </div>
